...
{
    /// <summary>
    ///     The object we are currently reading
    /// </summary>
    ...
    public override TDInstrument? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        var (properties, propertyNamesDictByCamelCaseNames) = SetPropertiesInfoForType(instrument.GetType());
    ...
    private (PropertyDescriptorCollection properties, Dictionary<string, string> propertyNamesDictByCamelCaseNames) SetPropertiesInfoForType(Type type)
    {
